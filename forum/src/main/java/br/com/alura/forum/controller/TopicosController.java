...
@RestController
@RequestMapping("/topicos") // esse controller cuida do /topicos
...
//        Pageable paginacao = PageRequest.of(pagina, qtd, Sort.Direction.ASC, ordenacao );
    ...
    public ResponseEntity<TopicoDto> cadastrar(@RequestBody @Valid TopicoForm form,
        ...
        //Devolvendo código após criação do recurso, devolve o caminho e o recurso criado
    ...
    //patch: alteração em um ou outro campo
    @PutMapping("/{id}")
    @Transactional
    @CacheEvict(value = "listaDeTopicos", allEntries = true)
